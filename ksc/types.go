...
const (
	...
	KindNameEndpoints               KindName = "Endpoints"
...
func GetResourceMap() map[string]Resource {
	// TODO: 如果需要支持多版本的kubernetes，可以在此处根据参数返回各个版本对应的ResourceMap
